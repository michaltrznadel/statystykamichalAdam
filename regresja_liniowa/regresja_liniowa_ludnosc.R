...
# Reszty to zasadniczo różnica między faktycznie 
#obserwowanymi wartościami odpowiedzi (w naszym przypadku odległość do zatrzymania) 
#a wartościami odpowiedzi przewidywanymi przez model.